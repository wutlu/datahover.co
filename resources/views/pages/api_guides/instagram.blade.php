	...
	<div class="container">
		...
		<div class="row mx-auto mb-5 pb-5">
			<div class="col-12 col-md-4">
				<small class="text-dark text-uppercase fw-bold d-block mb-4">Where can I use the Instagram API?</small>
			</div>
		...
		<div class="row mx-auto my-5 py-5">
			<div class="col-12 col-md-8 offset-md-2">
				<small class="text-dark text-uppercase fw-bold text-center d-block mb-4">How can I track a hashtag?</small>
		...
		<div class="row mx-auto my-5 py-5">
			<div class="col-12 col-md-4">
				<small class="text-dark text-uppercase fw-bold d-block mb-4">Why {{ config('app.name') }} Instagram API?</small>
			</div>
			<div class="col-12 col-md-8">
