		...
		@switch($status)
			@case('success')
				<div class="d-flex flex-column align-items-center gap-4">
					...
					<p class="success mb-4 text-center mw-300px">Your account has been charged. After <span class="intdown fw-bold">10</span> seconds you will be redirected to the <a title="Subscription" href="{{ route('subscription.index') }}" class="text-underline link-success fw-bold">Subscription Management</a> page.</p>
			...
			@case('cancel')
				<div class="d-flex flex-column align-items-center gap-4">
					...
					<p class="error mb-5 text-center mw-300px">Payment failed! After <span class="intdown fw-bold">10</span> seconds you will be redirected to the <a title="Subscription" href="{{ route('subscription.index') }}" class="text-underline link-danger fw-bold">Subscription Management</a> page.</p>
				</div>
			@break
		@endswitch
	</div>
