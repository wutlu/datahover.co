                ...
                <div class="modal-body">
                    <form
						...
						<div class="w-100 mb-4">
					    	...
					    	<small class="text-muted">Connect to your Twitter account. There may be several accounts that appear to be linked in your account. Please do not turn them off.</small>
						</div>

                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-outline-secondary shadow-sm rounded-0">Connect and Create</button>
                        </div>
                    </form>
                </div>
            </div>
