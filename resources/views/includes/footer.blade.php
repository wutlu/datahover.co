...
<footer class="bg-dark">
	<div class="container">
		<div class="row py-5">
			<div class="col-12 col-sm-6 col-lg-5 order-lg-1 order-3">
			...
			<div class="col-6 col-sm-6 col-lg-2 order-lg-2 order-1">
				<div class="d-flex flex-column mb-4">
			...
			<div class="col-6 col-sm-6 col-lg-2 order-lg-3 order-2">
				<div class="d-flex flex-column mb-4">
			...
			<div class="col-12 col-sm-6 col-lg-3 order-lg-4 order-4">
				<div class="d-flex flex-column mb-4">
